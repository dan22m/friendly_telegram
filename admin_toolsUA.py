...
class BanMod(loader.Module):
    ...
    strings = {"name": "AdminTools",
               ...
               "unban_none": "<b>Кого розбанити?</b>",
               "kick_none": "<b>Хто хоче примусово покинути чат?</b>",
               "promote_none": "<b>Хто хоче опку?</b>",
               "demote_none": "<b>Вкажи з кого зняти адмінку?</b>",
               "who": "<b>Кого...?</b>",
               "not_admin": "<b>Я не админістратор...</b>",
               "banned": "<code>{}</code> <b>Отримав бан!</b>\n<b>ID:</b> <code>{}</code>",
               "unbanned": "<code>{}</code> <b>Отримав розбан!</b>\n<b>ID:</b> <code>{}</code>",
               "kicked": "<code>{}</code> <b>Був кікнутим!</b>\n<b>ID:</b> <code>{}</code>",
               "promoted": "<code>{}</code> <b>Отримав права адміністратора!</b>\n<b>ID:</b> <code>{}</code>",
               "demoted": "<code>{}</code> <b>Втратив права адміністратора!</b>\n<b>ID:</b> <code>{}</code>"}
